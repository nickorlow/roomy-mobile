...
import {getCurrentUser, resetVars} from "../../roomy-api/ApiFunctions";
...
export default function WelcomeScreen({
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity onPress={() => {navigation.replace('Login');}} onLongPress={() => {resetVars(); getCurrentUser(); navigation.replace('Root');}} style={styles.link}>
